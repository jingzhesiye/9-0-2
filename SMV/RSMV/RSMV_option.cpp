...
#include <qwt_plot_panner.h>
 ...
 {
     //ui->RSMV_energyError_QwtPlot->setAxisScale(QwtPlot::xBottom, 0.0,10.0);
     //ui->RSMV_energyError_QwtPlot->setAxisScale(QwtPlot::yLeft,-10,10,5);
     //ui->RSMV_energyError_QwtPlot->enableAxis(QwtPlot::xBottom,false);  //隐藏x标
     //ui->RSMV_energyError_QwtPlot->enableAxis(QwtPlot::yLeft,false);  //隐藏y标

     //uiRSMV_energyError_QwtPlot
     ...
     //RSMV.wave_ESTD_grid->attach( ui->RSMV_energyError_QwtPlot );
...
//     RSMV.wave_ESTD_curve->setStyle( QwtPlotCurve::Lines );
     QwtSymbol *symbol = new QwtSymbol( QwtSymbol::Ellipse,
      ...
      (void) new QwtPlotMagnifier( ui->RSMV_energyError_QwtPlot->canvas() );
      (void) new QwtPlotPanner(ui->RSMV_energyError_QwtPlot->canvas()  );
  //鼠标放大
  #if 0
    ...
    RSMV.wave_ESTD_curve ->attach(ui->RSMV_energyError_QwtPlot);
